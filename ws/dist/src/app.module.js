...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_module_1.AuthModule, redis_module_1.RedisModule, websocket_module_1.WebsocketModule, config_1.ConfigModule.forRoot({
                isGlobal: true,
                load: [configService_1.default]
